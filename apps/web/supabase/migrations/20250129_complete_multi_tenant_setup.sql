...
-- 2. CREATE HELPER FUNCTION FOR CURRENT TENANT (Performance Optimization)
-- ==========================================

CREATE OR REPLACE FUNCTION auth.tenant_id()
RETURNS UUID AS $$
  SELECT COALESCE(
    -- First try app_metadata (most secure)
...
-- 7. HELPER FUNCTION TO LINK USER TO TENANT
-- ==========================================
...
-- 8. FUNCTION TO GET USER'S CURRENT TENANT
-- ==========================================
...
-- 10. CREATE TRIGGER FOR UPDATED_AT (if not exists)
-- ==========================================
...
-- ==========================================
-- 1. Link existing users to the demo tenant using the Admin panel or a script
-- 2. Update user app_metadata to include tenant_id
-- 3. Test that users can only see their own tenant's data
-- 4. Deploy the updated frontend hooks that use auth.tenant_id()