...
-- Mit korrekten Spaltennamen für en13813_recipe_materials
-- ================================================
...
BEGIN
    ...
    -- Materialzusammensetzung für CT-001 (mit korrekten Spaltennamen)
    INSERT INTO en13813_recipe_materials (
        tenant_id,
        recipe_id,
        binder_type,
        binder_designation,  -- Korrigiert von binder_name
        binder_amount_kg_m3,
        binder_supplier,
        water_content,
        water_binder_ratio,
        ...
        '[
            {"name": "Fließmittel FM-30", "dosage_percent": 0.8, "supplier": "BASF"},
            {"name": "Luftporenbildner LP-10", "dosage_percent": 0.2, "supplier": "Sika"},
            {"name": "Schwindreduzierer SR-5", "dosage_percent": 0.5, "supplier": "MC-Bauchemie"}
        ]'::jsonb
    );
    ...
    RAISE NOTICE '   - Mit vollständiger Materialzusammensetzung';
    RAISE NOTICE '   - ITT-Prüfergebnisse vorhanden';
    RAISE NOTICE '';
    RAISE NOTICE '2. DEMO-CA-002: Heizestrich C25-F4 mit λ=2.0 W/mK';
    RAISE NOTICE '   - RWFC250 für Bodenbelag';
    RAISE NOTICE '   - Optimiert für Fußbodenheizung';
    RAISE NOTICE '';
    RAISE NOTICE '3. DEMO-AS-003: Gussasphalt IC10';
    RAISE NOTICE '   - Brandklasse Bfl-s1 (System 3)';
    RAISE NOTICE '   - Für Industrieböden';
    RAISE NOTICE '';
    RAISE NOTICE '4. DEMO-SR-004: Epoxid B2.0-AR1-IR4';
    RAISE NOTICE '   - Parkhaus-Beschichtung';
    RAISE NOTICE '   - Chemikalienbeständig';
    RAISE NOTICE '';
    RAISE NOTICE '5. DEMO-MA-005: Magnesit C40-F7-SH100-RWA100';
    RAISE NOTICE '   - Hochfest für Industrie';
    RAISE NOTICE '   - Antistatisch';
    RAISE NOTICE '';
